...
static ngx_command_t  ngx_http_proxy_commands[] = {
    ...
    { ngx_string("proxyx_cookie_domain"),
      NGX_HTTP_MAIN_CONF|NGX_HTTP_SRV_CONF|NGX_HTTP_LOC_CONF|NGX_CONF_TAKE12,
    ...
    { ngx_string("proxyx_store_access"),
    ...
    { ngx_string("proxyx_ignore_client_abort"),
      NGX_HTTP_MAIN_CONF|NGX_HTTP_SRV_CONF|NGX_HTTP_LOC_CONF|NGX_CONF_FLAG,
      ngx_conf_set_flag_slot,
      NGX_HTTP_LOC_CONF_OFFSET,
    ...
    { ngx_string("proxyx_connect_timeout"),
      NGX_HTTP_MAIN_CONF|NGX_HTTP_SRV_CONF|NGX_HTTP_LOC_CONF|NGX_CONF_TAKE1,
    ...
    { ngx_string("proxyx_send_timeout"),
      NGX_HTTP_MAIN_CONF|NGX_HTTP_SRV_CONF|NGX_HTTP_LOC_CONF|NGX_CONF_TAKE1,
      ngx_conf_set_msec_slot,
      NGX_HTTP_LOC_CONF_OFFSET,
    ...
    { ngx_string("proxyx_intercept_errors"),
      NGX_HTTP_MAIN_CONF|NGX_HTTP_SRV_CONF|NGX_HTTP_LOC_CONF|NGX_CONF_FLAG,
      ngx_conf_set_flag_slot,
      NGX_HTTP_LOC_CONF_OFFSET,
    ...
    { ngx_string("proxyx_headers_hash_max_size"),
      NGX_HTTP_MAIN_CONF|NGX_HTTP_SRV_CONF|NGX_HTTP_LOC_CONF|NGX_CONF_TAKE1,
    ...
    { ngx_string("proxyx_headers_hash_bucket_size"),
      NGX_HTTP_MAIN_CONF|NGX_HTTP_SRV_CONF|NGX_HTTP_LOC_CONF|NGX_CONF_TAKE1,
      ngx_conf_set_num_slot,
      NGX_HTTP_LOC_CONF_OFFSET,
    ...
    { ngx_string("proxyx_pass_request_headers"),
      NGX_HTTP_MAIN_CONF|NGX_HTTP_SRV_CONF|NGX_HTTP_LOC_CONF|NGX_CONF_FLAG,
      ngx_conf_set_flag_slot,
      NGX_HTTP_LOC_CONF_OFFSET,
    ...
    { ngx_string("proxyx_pass_request_body"),
      NGX_HTTP_MAIN_CONF|NGX_HTTP_SRV_CONF|NGX_HTTP_LOC_CONF|NGX_CONF_FLAG,
      ngx_conf_set_flag_slot,
      NGX_HTTP_LOC_CONF_OFFSET,
    ...
    { ngx_string("proxyx_read_timeout"),
      NGX_HTTP_MAIN_CONF|NGX_HTTP_SRV_CONF|NGX_HTTP_LOC_CONF|NGX_CONF_TAKE1,
      ngx_conf_set_msec_slot,
      NGX_HTTP_LOC_CONF_OFFSET,
    ...
    { ngx_string("proxyx_busy_buffers_size"),
      NGX_HTTP_MAIN_CONF|NGX_HTTP_SRV_CONF|NGX_HTTP_LOC_CONF|NGX_CONF_TAKE1,
      ngx_conf_set_size_slot,
      NGX_HTTP_LOC_CONF_OFFSET,
    ...
    { ngx_string("proxyx_cache_path"),
      NGX_HTTP_MAIN_CONF|NGX_CONF_2MORE,
      ngx_http_file_cache_set_slot,
      0,
      0,
      &ngx_http_proxyx_module },

    { ngx_string("proxyx_cache_bypass"),
    ...
    { ngx_string("proxyx_cache_min_uses"),
      NGX_HTTP_MAIN_CONF|NGX_HTTP_SRV_CONF|NGX_HTTP_LOC_CONF|NGX_CONF_TAKE1,
      ngx_conf_set_num_slot,
      NGX_HTTP_LOC_CONF_OFFSET,
    ...
    { ngx_string("proxyx_cache_use_stale"),
      NGX_HTTP_MAIN_CONF|NGX_HTTP_SRV_CONF|NGX_HTTP_LOC_CONF|NGX_CONF_1MORE,
    ...
    { ngx_string("proxyx_cache_methods"),
      NGX_HTTP_MAIN_CONF|NGX_HTTP_SRV_CONF|NGX_HTTP_LOC_CONF|NGX_CONF_1MORE,
      ngx_conf_set_bitmask_slot,
      NGX_HTTP_LOC_CONF_OFFSET,
    ...
    { ngx_string("proxyx_cache_lock_timeout"),
      NGX_HTTP_MAIN_CONF|NGX_HTTP_SRV_CONF|NGX_HTTP_LOC_CONF|NGX_CONF_TAKE1,
      ngx_conf_set_msec_slot,
      NGX_HTTP_LOC_CONF_OFFSET,
    ...
    { ngx_string("proxyx_cache_revalidate"),
      NGX_HTTP_MAIN_CONF|NGX_HTTP_SRV_CONF|NGX_HTTP_LOC_CONF|NGX_CONF_FLAG,
      ngx_conf_set_flag_slot,
      NGX_HTTP_LOC_CONF_OFFSET,
    ...
    { ngx_string("proxyx_max_temp_file_size"),
      NGX_HTTP_MAIN_CONF|NGX_HTTP_SRV_CONF|NGX_HTTP_LOC_CONF|NGX_CONF_TAKE1,
      ngx_conf_set_size_slot,
      NGX_HTTP_LOC_CONF_OFFSET,
    ...
    { ngx_string("proxyx_temp_file_write_size"),
      NGX_HTTP_MAIN_CONF|NGX_HTTP_SRV_CONF|NGX_HTTP_LOC_CONF|NGX_CONF_TAKE1,
      ngx_conf_set_size_slot,
      NGX_HTTP_LOC_CONF_OFFSET,
    ...
    { ngx_string("proxyx_next_upstream"),
      NGX_HTTP_MAIN_CONF|NGX_HTTP_SRV_CONF|NGX_HTTP_LOC_CONF|NGX_CONF_1MORE,
      ngx_conf_set_bitmask_slot,
      NGX_HTTP_LOC_CONF_OFFSET,
    ...
    { ngx_string("proxyx_ignore_headers"),
      NGX_HTTP_MAIN_CONF|NGX_HTTP_SRV_CONF|NGX_HTTP_LOC_CONF|NGX_CONF_1MORE,
      ngx_conf_set_bitmask_slot,
      NGX_HTTP_LOC_CONF_OFFSET,
    ...
    { ngx_string("proxyx_http_version"),
      NGX_HTTP_MAIN_CONF|NGX_HTTP_SRV_CONF|NGX_HTTP_LOC_CONF|NGX_CONF_TAKE1,
    ...
    { ngx_string("proxyx_ssl_session_reuse"),
      NGX_HTTP_MAIN_CONF|NGX_HTTP_SRV_CONF|NGX_HTTP_LOC_CONF|NGX_CONF_FLAG,
      ngx_conf_set_flag_slot,
      NGX_HTTP_LOC_CONF_OFFSET,
    ...
    { ngx_string("proxyx_ssl_protocols"),
      NGX_HTTP_MAIN_CONF|NGX_HTTP_SRV_CONF|NGX_HTTP_LOC_CONF|NGX_CONF_1MORE,
      ngx_conf_set_bitmask_slot,
      NGX_HTTP_LOC_CONF_OFFSET,
...
ngx_module_t  ngx_http_proxyx_module = {
    NGX_MODULE_V1,
    &ngx_http_proxyx_module_ctx,            /* module context */
...
static ngx_http_variable_t  ngx_http_proxy_vars[] = {
    ...
    { ngx_string("proxyx_host"), NULL, ngx_http_proxy_host_variable, 0,
      NGX_HTTP_VAR_CHANGEABLE|NGX_HTTP_VAR_NOCACHEABLE|NGX_HTTP_VAR_NOHASH, 0 },

    { ngx_string("proxyx_port"), NULL, ngx_http_proxy_port_variable, 0,
      NGX_HTTP_VAR_CHANGEABLE|NGX_HTTP_VAR_NOCACHEABLE|NGX_HTTP_VAR_NOHASH, 0 },

    { ngx_string("proxyx_add_x_forwarded_for"), NULL,
      ngx_http_proxy_add_x_forwarded_for_variable, 0, NGX_HTTP_VAR_NOHASH, 0 },

#if 0
    { ngx_string("proxyx_add_via"), NULL, NULL, 0, NGX_HTTP_VAR_NOHASH, 0 },
#endif

    { ngx_string("proxyx_internal_body_length"), NULL,
...
{
    ngx_log_debug(NGX_LOG_DEBUG_HTTP, r->connection->log, 0, "ngx_http_proxy_handler");
    ngx_int_t                   rc;
    ...
    ngx_http_set_ctx(r, ctx, ngx_http_proxyx_module);

    plcf = ngx_http_get_module_loc_conf(r, ngx_http_proxyx_module);
    ...
    u->output.tag = (ngx_buf_tag_t) &ngx_http_proxyx_module;
    ...
    rc = ngx_http_read_client_request_body(r, ngx_http_upstreamx_init);
...
ngx_http_proxy_create_key(ngx_http_request_t *r)
{
    ...
    ctx = ngx_http_get_module_ctx(r, ngx_http_proxyx_module);
...
ngx_http_proxy_create_request(ngx_http_request_t *r)
{
    ...
    ngx_log_debug(NGX_LOG_DEBUG_HTTP, r->connection->log, 0, "ngx_http_proxy_create_request");
    ...
    le.ip = plcf->headers_set_len->elts;
    ngx_log_debug(NGX_LOG_DEBUG_HTTP, r->connection->log, 0, "check");
    while (*(uintptr_t *) le.ip) {
        lcode = *(ngx_http_script_len_code_pt *) le.ip;
        ...
        while (*(uintptr_t *) e.ip) {
            ...
            ngx_log_debug(NGX_LOG_DEBUG_HTTP, r->connection->log, 0, "check 1 1");

        }
        e.ip += sizeof(uintptr_t);
    }
    ngx_log_debug(NGX_LOG_DEBUG_HTTP, r->connection->log, 0, "check o");
...
ngx_http_proxy_create_loc_conf(ngx_conf_t *cf)
{
    ...
    /* "proxyx_cyclic_temp_file" is disabled */
...
ngx_http_proxy_merge_loc_conf(ngx_conf_t *cf, void *parent, void *child)
{
    ...
    if (conf->upstream.bufs.num < 2) {
        ngx_conf_log_error(NGX_LOG_EMERG, cf, 0,
                           "there must be at least 2 \"proxyx_buffers\"");
    ...
    if (conf->upstream.busy_buffers_size < size) {
        ngx_conf_log_error(NGX_LOG_EMERG, cf, 0,
             "\"proxyx_busy_buffers_size\" must be equal to or greater than "
             "the maximum of the value of \"proxyx_buffer_size\" and "
             "one of the \"proxyx_buffers\"");
    ...
    {
        ngx_conf_log_error(NGX_LOG_EMERG, cf, 0,
             "\"proxyx_busy_buffers_size\" must be less than "
             "the size of all \"proxyx_buffers\" minus one buffer");
    ...
    if (conf->upstream.temp_file_write_size < size) {
        ngx_conf_log_error(NGX_LOG_EMERG, cf, 0,
             "\"proxyx_temp_file_write_size\" must be equal to or greater "
             "than the maximum of the value of \"proxyx_buffer_size\" and "
             "one of the \"proxyx_buffers\"");
    ...
    {
        ngx_conf_log_error(NGX_LOG_EMERG, cf, 0,
             "\"proxyx_max_temp_file_size\" must be equal to zero to disable "
    ...
    if (conf->upstream.cache && conf->upstream.cache->data == NULL) {
        ...
        ngx_conf_log_error(NGX_LOG_EMERG, cf, 0,
                           "\"proxyx_cache\" zone \"%V\" is unknown",
                           &shm_zone->shm.name);
...
ngx_http_proxy_pass(ngx_conf_t *cf, ngx_command_t *cmd, void *conf)
{
        ...
        || clcf->noname)
    {
        if (plcf->vars.uri.len) {
            ngx_conf_log_error(NGX_LOG_EMERG, cf, 0,
                               "\"proxyx_pass\" cannot have URI part in "
...
ngx_http_proxy_redirect(ngx_conf_t *cf, ngx_command_t *cmd, void *conf)
{
    ...
    if (ngx_strcmp(value[1].data, "default") == 0) {
        if (plcf->proxy_lengths) {
            ngx_conf_log_error(NGX_LOG_EMERG, cf, 0,
                               "\"proxyx_redirect default\" cannot be used "
                               "with \"proxyx_pass\" directive with variables");
            return NGX_CONF_ERROR;
        }

        if (plcf->url.data == NULL) {
            ngx_conf_log_error(NGX_LOG_EMERG, cf, 0,
                               "\"proxyx_redirect default\" should be placed "
                               "after the \"proxyx_pass\" directive");
            return NGX_CONF_ERROR;
        }
...
ngx_http_proxy_store(ngx_conf_t *cf, ngx_command_t *cmd, void *conf)
{
    ...
    {
        return "is incompatible with \"proxyx_cache\"";
    }
...
ngx_http_proxy_cache(ngx_conf_t *cf, ngx_command_t *cmd, void *conf)
{
    ...
    if (plcf->upstream.store > 0 || plcf->upstream.store_lengths) {
        return "is incompatible with \"proxyx_store\"";
    }
...
ngx_http_proxy_lowat_check(ngx_conf_t *cf, void *post, void *data)
{
    ...
    if ((u_long) *np >= ngx_freebsd_net_inet_tcp_sendspace) {
        ngx_conf_log_error(NGX_LOG_EMERG, cf, 0,
                           "\"proxyx_send_lowat\" must be less than %d "
    ...
    ngx_conf_log_error(NGX_LOG_WARN, cf, 0,
                       "\"proxyx_send_lowat\" is not supported, ignored");
