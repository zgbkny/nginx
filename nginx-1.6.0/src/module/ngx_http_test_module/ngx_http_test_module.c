...
static ngx_int_t ngx_http_test_handler(ngx_http_request_t* r) {
    ...
    ngx_http_test_loc_conf_t* hlcf;
    hlcf = ngx_http_get_module_loc_conf(r, ngx_http_test_module);
    ...
    r->headers_out.content_length_n = hlcf->output_words.len + sizeof("test, ") - 1;
