...
static ngx_http_module_t ngx_http_server_guard_module_ctx = {
    NULL,
    NULL,
    ...
    ngx_http_server_guard_create_loc_conf,
    ngx_http_server_guard_merge_loc_conf
};

ngx_module_t ngx_http_server_guard_module = {
    NGX_MODULE_V1,
    &ngx_http_server_guard_module_ctx,
    ngx_http_server_guard_cmds,
    NGX_HTTP_MODULE,
    NULL,
    NULL,
    NULL,
